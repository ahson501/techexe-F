...
class CustomUserAAPlants(AbstractUser):
    extra_field = models.CharField(max_length=100, blank=True, null=True)  # Example field

    groups = models.ManyToManyField(
        'auth.Group',
        related_name='customuser_aaplants_groups',  # Unique related_name
        blank=True
    )
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='customuser_aaplants_permissions',  # Unique related_name
        blank=True
    )
