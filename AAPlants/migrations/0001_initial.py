    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='plants', to='AAPlants.category')),
            ],
        ),
        migrations.CreateModel(
            name='FeaturedPlant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='customuser_aaplants_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='customuser_aaplants_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
